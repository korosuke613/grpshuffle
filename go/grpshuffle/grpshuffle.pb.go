...
type RepeatShuffleRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ShuffleRequest *ShuffleRequest `protobuf:"bytes,1,opt,name=shuffleRequest,proto3" json:"shuffleRequest,omitempty"` // Shuffle setting
	Interval       uint64          `protobuf:"varint,2,opt,name=interval,proto3" json:"interval,omitempty"`            // The number of seconds to interval.
	Times          uint64          `protobuf:"varint,3,opt,name=times,proto3" json:"times,omitempty"`                  // The number of times repeated. If 0 is specified, it is unlimited.
}

func (x *RepeatShuffleRequest) Reset() {
	*x = RepeatShuffleRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpshuffle_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RepeatShuffleRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepeatShuffleRequest) ProtoMessage() {}

func (x *RepeatShuffleRequest) ProtoReflect() protoreflect.Message {
	mi := &file_grpshuffle_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepeatShuffleRequest.ProtoReflect.Descriptor instead.
func (*RepeatShuffleRequest) Descriptor() ([]byte, []int) {
	return file_grpshuffle_proto_rawDescGZIP(), []int{3}
}

func (x *RepeatShuffleRequest) GetShuffleRequest() *ShuffleRequest {
	if x != nil {
...
func (x *RepeatShuffleRequest) GetInterval() uint64 {
	if x != nil {
		return x.Interval
	}
	return 0
...
func (x *RepeatShuffleRequest) GetTimes() uint64 {
	if x != nil {
		return x.Times
	}
	return 0
...
var file_grpshuffle_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_grpshuffle_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_grpshuffle_proto_goTypes = []interface{}{
	...
	(*RepeatShuffleRequest)(nil), // 3: grpshuffle.RepeatShuffleRequest
}
var file_grpshuffle_proto_depIdxs = []int32{
	0, // 0: grpshuffle.ShuffleResponse.combinations:type_name -> grpshuffle.Combination
	1, // 1: grpshuffle.RepeatShuffleRequest.shuffleRequest:type_name -> grpshuffle.ShuffleRequest
	1, // 2: grpshuffle.Compute.Shuffle:input_type -> grpshuffle.ShuffleRequest
	3, // 3: grpshuffle.Compute.RepeatShuffle:input_type -> grpshuffle.RepeatShuffleRequest
	2, // 4: grpshuffle.Compute.Shuffle:output_type -> grpshuffle.ShuffleResponse
	2, // 5: grpshuffle.Compute.RepeatShuffle:output_type -> grpshuffle.ShuffleResponse
...
func file_grpshuffle_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_grpshuffle_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RepeatShuffleRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
